...
echo 'export JAVA_OPTS="-Dkieker.monitoring.configuration=/kieker/config/kieker.monitoring.properties -Dcom.sun.jndi.ldap.object.disableEndpointIdentification=true"' > /usr/local/tomcat/bin/setenv.sh
